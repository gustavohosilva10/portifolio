...
export default function HomePage() {
  return (
    <div className="flex flex-col gap-6">
      <p className="text-sm">
        Transformando café em código há 4+ anos. Especialista em PHP, Laravel, React e Python, construindo soluções inovadoras e escaláveis. Formado em Análise e Desenvolvimento de Sistemas com uma pitada de Inteligência Artificial e Ciência de Dados.
      </p>
